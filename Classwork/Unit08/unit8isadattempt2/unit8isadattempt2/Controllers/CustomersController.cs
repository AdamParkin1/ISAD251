...
using unit8isadattempt2.Models;

namespace unit8isadattempt2.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CustomersController : ControllerBase
    {
        private readonly ISAD251_AParkinContext _context;

        public CustomersController(ISAD251_AParkinContext context)
        {
            _context = context;
        }
